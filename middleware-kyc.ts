...
export function middleware(request: NextRequest) {
  ...
  const cspDirectives = [
    "default-src 'self'",
    `script-src 'self' 'nonce-${nonce}' https://apis.google.com https://www.gstatic.com https://www.google.com https://www.googletagmanager.com https://static.sumsub.com`,
    `style-src 'self' 'nonce-${nonce}' https://fonts.googleapis.com https://static.sumsub.com`,
    ...
    "frame-src 'self' https://api.sumsub.com", // Allow Sumsub SDK frames
    "object-src 'none'",
    "base-uri 'self'",
