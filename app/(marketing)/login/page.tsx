...
import { ArrowLeft, AlertCircle, Mail, Lock, Eye, EyeOff, ChevronLeft } from "lucide-react"
      ...
      <div className="w-full max-w-md z-10">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-neutral-600">
            {isLogin ? "Sign in to access your account" : "Sign up to start using ClearHold"}
          </p>
        </div>
        ...
        {currentStep === "auth" && showPasswordlessSuccess && (
          <PasswordlessSignInForm 
            ...
            onError={(error) => {
              setError(error)
              setShowPasswordlessSuccess(false)
            }}
          />
        )}
